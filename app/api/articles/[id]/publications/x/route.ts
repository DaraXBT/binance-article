...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    const kind = publicationKind(requestedKind ?? undefined, 'post');
    ...
    return errorResponse(error, {
      ...
      message: 'The X publication draft could not be loaded.',
      status: 500,
    });
  }
}
...
export async function PUT(request: NextRequest, context: RouteContext) {
  try {
    ...
    const kind = publicationKind(body.kind, 'post');
    ...
    return errorResponse(error, {
      ...
      message: 'The X publication draft could not be saved.',
      status: 400,
    });
  }
}
