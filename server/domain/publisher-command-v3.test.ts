...
describe('kind-aware publisher command success evidence', () => {
  it('accepts an exact canonical X Article URL for an article command', () => {
    expect(transitionPublisherCommand(
      publishing,
      success('https://x.com/i/article/123456789'),
      now,
    )).toMatchObject({
      state: 'succeeded',
      target: 'x',
      kind: 'article',
      publishedUrl: 'https://x.com/i/article/123456789',
    });
  });

  it.each([
    'https://x.com/example_user/status/123456789',
    'https://x.com/example_user/article/123456789',
    'https://x.com/i/article/123456789?ref=home',
    'https://x.com/i/article/123456789#fragment',
    'https://www.x.com/i/article/123456789',
