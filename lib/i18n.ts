...
const en = {
  ...
  auth: {
    ...
    codeExpired: 'That enrollment code has expired. Ask the workspace owner for a new code.',
    codeRotated: 'That enrollment code was rotated. Ask the workspace owner for the latest code.',
    codeCapacityFull: 'The private beta is currently full. Ask the workspace owner about availability.',
    ...
    authErrorSignupDisabled: 'This sign-in link is for existing members. To create an account, open the latest enrollment link and enter its code.',
    authErrorCancelled: 'Google sign-in was cancelled. You can return and try again.',
    authErrorInvalidClaim: 'This enrollment has expired or was revoked. Ask the workspace owner for the latest code.',
    authErrorCapacityFull: 'The private beta is currently full. Ask the workspace owner about availability.',
    authErrorAccountDisabled: 'This account is suspended or revoked. Contact the workspace owner.',
