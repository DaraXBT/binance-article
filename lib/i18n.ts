...
const id: typeof en = {
  ...
  workspace: {
    onboardingTitle: 'Siapkan ruang kerja Anda',
    onboardingDescription:
      'Buat kunci pemulihan baru atau hubungkan kembali ruang kerja yang ada sebelum masuk ke dasbor.',
    createWorkspaceTitle: 'Buat kunci ruang kerja baru',
    createWorkspaceDescription: 'Hasilkan kunci pemulihan baru untuk sesi browser ini.',
    createWorkspaceAction: 'Buat kunci baru',
    createWorkspaceLoading: 'Membuat kunci...',
    recoverWorkspaceTitle: 'Pulihkan ruang kerja yang ada',
    recoverWorkspaceDescription: 'Gunakan kunci pemulihan yang telah disimpan sebelumnya untuk menghubungkan kembali browser ini.',
    openRecoverDialogAction: 'Gunakan kunci yang ada',
...
const lo: typeof en = {
  ...
  workspace: {
    onboardingTitle: 'ຕັ້ງຄ່າພື້ນທີ່ເຮັດວຽກຂອງທ່ານ',
    onboardingDescription:
      'ສ້າງກະແຈກູ້ຄືນໃໝ່ ຫຼື ເຊື່ອມຕໍ່ພື້ນທີ່ເຮັດວຽກທີ່ມີຢູ່ແລ້ວ ກ່ອນເຂົ້າສູ່ໜ້າຫຼັກ.',
    createWorkspaceTitle: 'ສ້າງກະແຈພື້ນທີ່ເຮັດວຽກໃໝ່',
    createWorkspaceDescription: 'ສ້າງກະແຈກູ້ຄືນໃໝ່ສຳລັບເຊດຊັນບຣາວເຊີນີ້.',
    createWorkspaceAction: 'ສ້າງກະແຈໃໝ່',
    createWorkspaceLoading: 'ກຳລັງສ້າງກະແຈ...',
    recoverWorkspaceTitle: 'ກູ້ຄືນພື້ນທີ່ເຮັດວຽກທີ່ມີຢູ່ແລ້ວ',
    recoverWorkspaceDescription: 'ໃຊ້ກະແຈກູ້ຄືນທີ່ບັນທຶກໄວ້ກ່ອນໜ້ານີ້ ເພື່ອເຊື່ອມຕໍ່ບຣາວເຊີນີ້ຄືນ.',
    openRecoverDialogAction: 'ໃຊ້ກະແຈທີ່ມີຢູ່ແລ້ວ',
...
const my: typeof en = {
  ...
  workspace: {
    onboardingTitle: 'သင့်အလုပ်ခွင်ကို စတင်ပြင်ဆင်ပါ',
    onboardingDescription:
      'ဒက်ရှ်ဘုတ်သို့ မဝင်မီ ပြန်လည်ရယူရေးသော့ အသစ်ဖန်တီးပါ သို့မဟုတ် ရှိပြီးအလုပ်ခွင်ကို ပြန်ချိတ်ဆက်ပါ။',
    createWorkspaceTitle: 'အလုပ်ခွင် သော့အသစ် ဖန်တီး',
    createWorkspaceDescription: 'ဤဘရောက်ဆာ စက်ရှင်အတွက် ပြန်လည်ရယူရေးသော့ အသစ် ထုတ်လုပ်ပါ။',
    createWorkspaceAction: 'သော့အသစ် ဖန်တီး',
    createWorkspaceLoading: 'သော့ ဖန်တီးနေသည်...',
    recoverWorkspaceTitle: 'ရှိပြီးအလုပ်ခွင်ကို ပြန်လည်ရယူ',
    recoverWorkspaceDescription: 'ယခင်သိမ်းဆည်းထားသော ပြန်လည်ရယူရေးသော့ဖြင့် ဤဘရောက်ဆာကို ပြန်ချိတ်ဆက်ပါ။',
    openRecoverDialogAction: 'ရှိပြီးသော့ အသုံးပြု',
...
const fil: typeof en = {
  ...
  workspace: {
    onboardingTitle: 'I-set up ang iyong workspace',
    onboardingDescription:
      'Gumawa ng bagong recovery key o ikonekta muli ang isang umiiral na workspace bago pumasok sa dashboard.',
    createWorkspaceTitle: 'Gumawa ng bagong workspace key',
    createWorkspaceDescription: 'Bumuo ng bagong recovery key para sa browser session na ito.',
    createWorkspaceAction: 'Gumawa ng bagong key',
    createWorkspaceLoading: 'Gumagawa ng key...',
    recoverWorkspaceTitle: 'I-recover ang umiiral na workspace',
    recoverWorkspaceDescription: 'Gamitin ang dating naka-save na recovery key upang ikonekta muli ang browser na ito.',
    openRecoverDialogAction: 'Gamitin ang umiiral na key',
